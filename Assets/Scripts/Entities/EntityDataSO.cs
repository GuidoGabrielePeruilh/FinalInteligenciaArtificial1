...
namespace IA_I.SO
{
    ...
    public class EntityDataSO : ScriptableObject
    {
        ...
        [field: SerializeField, Range(0.5f, 5f)] public float AttackCooldown { get; private set; } = 1f;
        [field: SerializeField, Range(0.5f, 10f)] public float AttackRadius { get; private set; } = 1f;
